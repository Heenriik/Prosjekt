...
if __name__ == "__main__":
    ...
    if torch.cuda.is_available():
        ...
        accelerator = "cpu"
        strategy = None
        args.ngpus = 1  # CPU doesn't support multi-device
    ### END ADDED FOR PC WITH NO GPU -H ###


    trainer = pl.Trainer(devices=args.ngpus,
                         strategy=strategy, # <- CHANGED -H
                         accelerator=accelerator, # <- CHANGED -H
